...
def system(Title, password, file):
    st.title(Title)
...
page = st.sidebar.radio("Go to:", ["Home", "GALAU 3.0", "TEATER","sport day"])
...
if page == "Home":
    ...
    st.markdown("Welcome! Choose Your Event")

elif page == "GALAU 3.0":
    
    st.title("GALAU 3.0 Attendance System")
    st.set_page_config(page_title="ONE TICKET", layout="centered")
