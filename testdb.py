...
#Main Function==========================================================================
def system(Title, password, mainId, attId):
   ...
   #Event selection=========================================================================    
    ...
    # If user has chosen an event → open that page
        ...
        if st.session_state.selected_event == "ROCK INDIE":
            ...
            system("MAJMUK ALAM", "2222", "1USLaPBsO-k41lUF-LayyFtyYFMrCCu8SJxEo7hdwNmc","1-6a1mCrUAfBTPDt_2oNnPl6BrrSmHRdpfpaFR0f3-Co")
